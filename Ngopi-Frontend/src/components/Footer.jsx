...
function Footer() {
    return (
        <footer className="bg-light text-center text-lg-start mt-5" style={{fontFamily: 'Plus Jakarta Sans, sans-serif', height: 'auto'}}>

            <div className="text-center footer-container align-items-center justify-content-center pt-4 py-4">

                <div className="row d-flex justify-content-center align-items-center">
                    <div className="col align-items-center justify-content-center">
                        <a href="https://github.com/Retiortuk" className="text-decoration-none" target="_blank">
                            <svg width="24px" height="24px" viewBox="0 0 48 48" id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" fill="#000000">
                                <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                                <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                                    {/* Tag <defs> dan <style> dihapus */}
                                    <path 
                                        style={{
                                            fill: 'none',
                                            stroke: '#000000',
                            ...
                            <p className="fst-italic retiortuk">Web Created By: Retiortuk</p>
                        </a>
                    </div>
                </div>
